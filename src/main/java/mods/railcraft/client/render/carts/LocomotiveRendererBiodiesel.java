 ...
 */
public class LocomotiveRendererBiodiesel extends LocomotiveRendererDefault {
    ...
    public LocomotiveRendererBiodiesel() {
        super("railcraft:default", "locomotive.model.biodiesel.default", new ModelLocomotiveDiesel(), new ModelLocomotiveDiesel(0.125F));
