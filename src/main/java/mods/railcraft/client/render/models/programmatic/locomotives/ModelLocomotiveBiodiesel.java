...
public class ModelLocomotiveBiodiesel extends ModelSimple {

    public ModelLocomotiveBiodiesel() {
        this(0f);
    }

    public ModelLocomotiveBiodiesel(float scale) {
        super("loco");
...
//        loco.setTextureOffset( 1, 45).addBox( -2F, -18F, -10F, 6, 4, 4, scale);
        ...
        //chimney
        loco.setTextureOffset(110, 26).addBox(-7F, -21F, -10F, 4, 2, 4, scale);
